...
//mocking fetchShow outside of the tests
...
test('Tests to see if App renders', () => {
    //mocks fetchData with showData
    mockFetchShow.mockResolvedValueOnce(showData);
    render(<App />);
});

test('Tests if api call was successful', async () => {
    //mocks fetchData with showData
    mockFetchShow.mockResolvedValueOnce(showData);

    let { getByTestId, getByPlaceholderText, getByText, queryAllByTestId } = render(<App />);
    ...
    await waitFor(() => {
        // userEvent.click(getByTestId(/dropdown/i));
        // userEvent.click(getByPlaceholderText(/select a season/i));
        userEvent.click(getByText(/select a season/i));
        ...
        // userEvent.click(getByTestId(/dropdown/i));
        // userEvent.click(getByText(/season 2/));
        // expect(queryAllByTestId(/episodes/i)).toHaveLength(9);


        // userEvent.click(queryAllByTestId(/season 2/i));
